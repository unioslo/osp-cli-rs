...
pub mod runtime {
    pub use crate::osp_config::{
        ...
        DEFAULT_REPL_HISTORY_MAX_ENTRIES, DEFAULT_REPL_HISTORY_PROFILE_SCOPED,
        DEFAULT_REPL_INTRO_STYLE, DEFAULT_SESSION_CACHE_MAX_RESULTS, DEFAULT_UI_CHROME_FRAME,
        ...
        DEFAULT_UI_MREG_STACK_OVERFLOW_RATIO, DEFAULT_UI_PRESENTATION, DEFAULT_UI_SHORT_LIST_MAX,
        DEFAULT_UI_TABLE_BORDER, DEFAULT_UI_TABLE_OVERFLOW, DEFAULT_UI_WIDTH, RuntimeConfig,
        RuntimeConfigPaths, RuntimeDefaults, RuntimeLoadOptions,
    };
}
