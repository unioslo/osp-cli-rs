...
use crate::osp_cli::app::TimingSummary;
use crate::osp_cli::app::{CMD_CONFIG, CMD_HELP, CMD_PLUGINS, CMD_THEME};
use crate::osp_cli::plugin_manager::PluginManager;
use crate::osp_cli::repl::ReplViewContext;
use crate::osp_cli::repl::surface::{ReplOverviewEntry, ReplSurface};
...
fn repl_appearance_respects_color_toggle_and_overrides() {
    ...
    rich_state.runtime.ui.render_settings.mode = crate::osp_core::output::RenderMode::Rich;
    rich_state.runtime.ui.render_settings.color = crate::osp_core::output::ColorMode::Always;
    rich_state.runtime.ui.render_settings.unicode = crate::osp_core::output::UnicodeMode::Always;
...
fn repl_prompt_right_shows_unicode_incognito_when_history_is_disabled() {
    ...
    settings.mode = crate::osp_core::output::RenderMode::Rich;
    settings.color = crate::osp_core::output::ColorMode::Always;
    settings.unicode = crate::osp_core::output::UnicodeMode::Always;
...
fn repl_prompt_renders_custom_template_with_prompt_style() {
    ...
    state.session.scope.enter("ldap");
    state.runtime.ui.render_settings.mode = crate::osp_core::output::RenderMode::Rich;
    state.runtime.ui.render_settings.color = crate::osp_core::output::ColorMode::Always;
    state.runtime.ui.render_settings.unicode = crate::osp_core::output::UnicodeMode::Always;
