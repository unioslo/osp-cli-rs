...
use crate::osp_ui::render_inline;
use crate::osp_ui::style::{
...
fn render_chrome_section(
    resolved: &crate::osp_ui::ResolvedRenderSettings,
    title: &str,
    lines: &[String],
) -> String {
    let theme = &resolved.theme;
...
fn style_command_name(
    resolved: &crate::osp_ui::ResolvedRenderSettings,
    theme: &crate::osp_ui::theme::ThemeDefinition,
    name: &str,
) -> String {
    if resolved.color {
        apply_style_with_theme_overrides(
...
) -> crate::osp_repl::PromptRightRenderer {
    let resolved = view.ui.render_settings.resolve_render_settings();
...
struct PromptTemplateStyleContext<'a> {
    ...
    color: bool,
    theme: &'a crate::osp_ui::theme::ThemeDefinition,
}
