...
pub(crate) struct ConfigExplainContext<'a> {
    ...
    pub(crate) session_layer: &'a crate::osp_config::ConfigLayer,
    pub(crate) runtime_load: crate::osp_config::RuntimeLoadOptions,
}
...
fn precedence_chain(
    ...
    for layer in &explain.layers {
        let mut candidates = layer
            ...
            .collect::<Vec<(u8, &crate::osp_config::ExplainCandidate)>>();
...
pub(crate) fn format_scope(scope: &crate::osp_config::Scope) -> String {
