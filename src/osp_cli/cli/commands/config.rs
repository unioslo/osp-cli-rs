...
use crate::osp_cli::rows::RowBuilder;
use crate::osp_cli::rows::output::rows_to_output_result;
use crate::osp_cli::state::{RuntimeContext, TerminalKind, UiState};
use crate::osp_cli::theme_loader::ThemeCatalog;
#[cfg(unix)]
use crate::osp_config::secret_file_mode;
...
use crate::osp_ui::messages::MessageBuffer;
...
fn session_scoped_value(
    ...
    key: &str,
    scope: &Scope,
) -> Option<crate::osp_config::ConfigValue> {
    layer
        .entries()
        .iter()
...
fn validate_write_scopes(
    key: &str,
    scopes: &[Scope],
) -> std::result::Result<(), crate::osp_config::ConfigError> {
    for scope in scopes {
...
mod tests {
    ...
    use crate::osp_cli::cli::{ConfigSetArgs, ConfigUnsetArgs};
    use crate::osp_cli::state::{RuntimeContext, TerminalKind, UiState};
    use crate::osp_cli::theme_loader::ThemeCatalog;
    use crate::osp_config::{
    ...
    fn resolve_terminal_selector_handles_current_sentinel_and_blank_values() {
        ...
        assert_eq!(
            resolve_terminal_selector(repl, Some(crate::osp_cli::app::CURRENT_TERMINAL_SENTINEL)),
            Some("repl".to_string())
        );
    ...
    fn config_get_rows_resolves_bootstrap_only_keys_through_runtime_explain_unit() {
        ...
        let rows = config_get_rows(
            read_context(TerminalKind::Cli),
            &crate::osp_cli::cli::ConfigGetArgs {
    ...
    fn resolve_config_scopes_covers_known_profiles_and_active_profile_terminal_unit() {
        ...
        defaults.insert(
            "ui.format".to_string(),
            crate::osp_config::ConfigValue::from("json"),
            Scope::profile("ops"),
        );
        defaults.insert(
            "ui.format".to_string(),
            crate::osp_config::ConfigValue::from("table"),
            Scope::profile("dev"),
        );
        let context = read_context_with_defaults(TerminalKind::Cli, defaults);
    ...
    fn validate_write_scopes_and_session_lookup_cover_invalid_and_present_paths_unit() {
        ...
        assert_eq!(
            ...
            Some(crate::osp_config::ConfigValue::from("json"))
        );
        assert_eq!(
