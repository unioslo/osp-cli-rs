use super::*;
use crate::osp_completion::{ArgNode, FlagNode, SuggestionEntry, ValueType};
...
pub(super) fn to_value_type(
    value_type: crate::osp_core::plugin::DescribeValueTypeV1,
) -> Option<ValueType> {
    match value_type {
        crate::osp_core::plugin::DescribeValueTypeV1::Path => Some(ValueType::Path),
    }
}
