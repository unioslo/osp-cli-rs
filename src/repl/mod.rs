...
pub use debug::{
    ...
    HighlightDebugSpan, color_from_style_spec, debug_completion, debug_completion_steps,
    debug_highlight,
};
pub use history::{
...
pub use prompt::{LineProjection, LineProjector, PromptRightRenderer, ReplAppearance, ReplPrompt};
pub use run::{
