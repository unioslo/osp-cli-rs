...
use crate::ui::document::{Block, Document, MregBlock, MregValue, TableBlock};
use crate::ui::width::{display_width, mreg_alignment_key_width};
use crate::ui::{RenderBackend, ResolvedRenderSettings, TableOverflow};
...
mod tests {
    ...
    use crate::ui::width::strip_count_suffix;
