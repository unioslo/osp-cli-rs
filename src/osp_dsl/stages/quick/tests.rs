...
use crate::osp_dsl::eval::flatten::flatten_row;
use crate::osp_dsl::parse::key_spec::ExactMode;
...
fn quick_value_scope_projects_synthetic_rows_and_drops_empty_results_unit() {
    ...
    let mut empty_result = MatchResult {
        ...
        value_hits: Vec::new(),
        is_projection: true,
        synthetic: crate::osp_core::row::Row::new(),
    };
...
fn quick_projection_and_negation_helpers_cover_empty_synthetic_and_array_removal_unit() {
    ...
    let flat_projection = crate::osp_core::row::Row::new();
