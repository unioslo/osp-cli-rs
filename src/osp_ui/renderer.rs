...
use crate::osp_ui::display::value_to_display;
use crate::osp_ui::document::{
    Block, Document, MregBlock, MregValue, PanelRules, TableAlign, TableBlock, TableStyle,
};
use crate::osp_ui::layout::{LayoutContext, MregEntryMetrics, MregMetrics, prepare_layout_context};
use crate::osp_ui::style::{StyleToken, apply_style_spec, apply_style_with_theme_overrides};
use crate::osp_ui::width::{display_width, mreg_alignment_key_width};
...
impl<'a> DocumentRenderer<'a> {
    ...
    fn render_line_block(&self, block: &crate::osp_ui::document::LineBlock) -> String {
        let mut out = String::new();
    ...
    fn render_code_block(&self, block: &crate::osp_ui::document::CodeBlock) -> String {
    ...
    fn render_panel_block(&self, block: &crate::osp_ui::document::PanelBlock) -> String {
        let fallback =
...
mod tests {
    ...
    use crate::osp_ui::RenderBackend;
    use crate::osp_ui::document::{
        Block, Document, JsonBlock, MregBlock, MregEntry, MregRow, MregValue, PanelBlock,
        TableAlign, TableBlock, TableStyle, ValueBlock,
    };
    use crate::osp_ui::format;
    use crate::osp_ui::{RenderRuntime, RenderSettings};
    use crate::osp_ui::{ResolvedRenderSettings, TableOverflow};
    ...
    fn settings(backend: RenderBackend, color: bool, unicode: bool) -> ResolvedRenderSettings {
        ResolvedRenderSettings {
            ...
            table_border: crate::osp_ui::TableBorderStyle::Square,
            ...
            chrome_frame: crate::osp_ui::chrome::SectionFrameStyle::Top,
        }
    }
    ...
    fn panel_rules_match_python_plain_layout() {
        let document = Document {
            blocks: vec![Block::Panel(PanelBlock {
                ...
                rules: crate::osp_ui::document::PanelRules::Both,
    ...
    fn mreg_scalar_entries_render_inline() {
        ...
        let rendered = render_document(
            ...
            ResolvedRenderSettings {
                ...
                table_border: crate::osp_ui::TableBorderStyle::Square,
                theme_name: crate::osp_ui::theme::DEFAULT_THEME_NAME.to_string(),
                theme: crate::osp_ui::theme::resolve_theme(
                    crate::osp_ui::theme::DEFAULT_THEME_NAME,
                ),
                style_overrides: crate::osp_ui::style::StyleOverrides::default(),
                chrome_frame: crate::osp_ui::chrome::SectionFrameStyle::Top,
            },
    ...
    fn render_table_toggles_border_style() {
        ...
        round.table_border = crate::osp_ui::TableBorderStyle::Round;
        let mut square = settings(RenderBackend::Plain, false, false);
        square.table_border = crate::osp_ui::TableBorderStyle::Square;
        let mut none = settings(RenderBackend::Rich, false, true);
        none.table_border = crate::osp_ui::TableBorderStyle::None;
    ...
    fn plain_theme_does_not_style_hex_cells() {
        ...
        let rendered = render_document(
            ...
            ResolvedRenderSettings {
                ...
                theme: crate::osp_ui::theme::resolve_theme("plain"),
                style_overrides: crate::osp_ui::style::StyleOverrides::default(),
                chrome_frame: crate::osp_ui::chrome::SectionFrameStyle::Top,
            },
        );
    ...
    fn code_block_honors_color_code_override() {
        let document = Document {
            blocks: vec![Block::Code(crate::osp_ui::document::CodeBlock {
        ...
        let rendered = render_document(
            ...
            ResolvedRenderSettings {
                ...
                style_overrides: crate::osp_ui::style::StyleOverrides {
