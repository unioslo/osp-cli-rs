...
use crate::osp_core::output_model::{OutputItems, OutputResult};
...
mod tests {
    ...
    use crate::osp_core::row::Row;
    use crate::osp_ui::document::{Block, MregValue, TableStyle};
    use serde_json::json;
    ...
    fn render_document_helpers_force_plain_copy_mode_unit() {
        let document = crate::osp_ui::Document {
            blocks: vec![Block::Line(crate::osp_ui::LineBlock {
                parts: vec![crate::osp_ui::LinePart {
