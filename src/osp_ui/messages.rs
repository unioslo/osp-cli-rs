use crate::osp_ui::document::{Block, Document, LineBlock, LinePart};
use crate::osp_ui::inline::render_inline;
use crate::osp_ui::renderer::render_document;
use crate::osp_ui::style::{StyleOverrides, StyleToken};
...
impl MessageBuffer {
    ...
    pub fn render_grouped(&self, max_level: MessageLevel) -> String {
        let theme = crate::osp_ui::theme::resolve_theme("plain");
...
mod tests {
    ...
    fn styled_render_uses_boxed_headers() {
        let mut messages = MessageBuffer::default();
        messages.error("bad");
        let theme = crate::osp_ui::theme::resolve_theme("rose-pine-moon");
