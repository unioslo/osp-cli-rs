use crate::osp_dsl::model::{ParsedPipeline, ParsedStage, ParsedStageKind};
use crate::osp_dsl::verbs::is_registered_explicit_verb;
...
#[cfg(test)]
mod tests {
    use crate::osp_dsl::model::ParsedStageKind;
