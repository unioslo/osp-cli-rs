...
use crate::osp_ui::document::{Block, Document, MregBlock, MregValue, TableBlock};
use crate::osp_ui::width::{display_width, mreg_alignment_key_width};
use crate::osp_ui::{RenderBackend, ResolvedRenderSettings, TableOverflow};
...
mod tests {
    ...
    use crate::osp_ui::width::strip_count_suffix;
    use crate::osp_ui::{RenderBackend, ResolvedRenderSettings};
    use serde_json::json;
    ...
    fn rich_settings(width: Option<usize>) -> ResolvedRenderSettings {
        ResolvedRenderSettings {
            ...
            grid_columns: None,
            column_weight: 3,
            table_overflow: crate::osp_ui::TableOverflow::Clip,
            table_border: crate::osp_ui::TableBorderStyle::Square,
            theme_name: DEFAULT_THEME_NAME.to_string(),
            theme: crate::osp_ui::theme::resolve_theme(DEFAULT_THEME_NAME),
