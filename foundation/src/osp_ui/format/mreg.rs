...
use crate::osp_ui::document::{Block, MregBlock, MregEntry, MregRow, MregValue, TableBlock, TableStyle};
use crate::osp_ui::width::display_width;
...
mod tests {
    ...
    use crate::osp_ui::document::{Block, MregBlock, MregValue, TableBlock};
    ...
    fn shrink_column_widths_stops_at_minimum_width() {
        let table = TableBlock {
            block_id: 1,
            style: crate::osp_ui::document::TableStyle::Grid,
