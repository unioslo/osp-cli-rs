...
use crate::osp_repl::CompletionTraceMenuState;
use crate::osp_repl::menu_core::{MenuAction, MenuCore};

#[allow(unused_imports)]
pub(crate) use crate::osp_repl::menu_core::{MenuDebug, MenuStyleDebug, StyleDebug, display_text};
...
impl OspCompletionMenu {
    ...
    fn apply_selection(
        ...
        if crate::osp_repl::trace_completion_enabled() {
            ...
            crate::osp_repl::trace_completion(crate::osp_repl::CompletionTraceEvent {
                event,
                line: &line_before,
