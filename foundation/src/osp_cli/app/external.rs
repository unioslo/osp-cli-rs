...
use crate::osp_cli::cli::{Commands, parse_inline_command_tokens};
use crate::osp_cli::invocation::{InvocationOptions, append_invocation_help_if_verbose};
use crate::osp_cli::pipeline::parse_command_tokens_with_aliases;
use crate::osp_cli::plugin_manager::PluginManager;
use crate::osp_cli::repl::ReplViewContext;
use crate::osp_cli::repl::completion;
...
pub(super) struct ExternalCommandRuntime<'a> {
    ...
    pub(super) config_state: &'a crate::osp_cli::state::ConfigState,
    ...
    run_external_command_with_help_renderer(
        ...
        |stdout| {
            ...
            let body = if invocation.show_invocation_help {
                crate::osp_cli::invocation::append_invocation_help(stdout)
            } else {
                stdout.to_string()
            };
...
fn render_external_plugin_response(
    response: crate::osp_core::plugin::ResponseV1,
    stages: &[String],
) -> Result<CliCommandResult> {
...
mod tests {
    ...
    use crate::osp_cli::app::{CliCommandResult, ReplCommandOutput};
    use crate::osp_cli::plugin_manager::PluginManager;
    ...
    use crate::osp_core::plugin::{ResponseMessageLevelV1, ResponseMessageV1, ResponseMetaV1, ResponseV1};
