...
use crate::osp_cli::cli::HistoryArgs;
use crate::osp_cli::repl::history as repl_history;
...
pub(crate) fn run_history_repl_command(
    ...
    args: HistoryArgs,
    history: &crate::osp_repl::SharedHistory,
) -> Result<CliCommandResult> {
    let output = repl_history::run_history_repl_command(session, args, history)?;
    Ok(CliCommandResult {
        exit_code: 0,
        messages: crate::osp_ui::messages::MessageBuffer::default(),
        output: Some(output),
        stderr_text: None,
        failure_report: None,
    })
...
mod tests {
    ...
    use crate::osp_cli::cli::{HistoryArgs, HistoryCommands};
    use crate::osp_cli::state::AppSession;
    use crate::osp_core::row::Row;
    use crate::osp_repl::HistoryConfig;
    ...
    fn history_repl_command_wraps_repl_output_for_cli_unit() {
        ...
        let history = crate::osp_repl::SharedHistory::new(
            HistoryConfig {
