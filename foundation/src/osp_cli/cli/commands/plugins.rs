...
use crate::osp_cli::plugin_manager::{CommandCatalogEntry, DoctorReport, PluginManager, PluginSummary};
use crate::osp_cli::rows::output::rows_to_output_result;
use crate::osp_cli::state::{AppClients, AuthState, ConfigState};
use miette::Result;
...
fn plugin_config_rows(plugin_id: &str, entries: &[crate::osp_cli::app::PluginConfigEntry]) -> Vec<Row> {
    if entries.is_empty() {
        return vec![crate::osp_cli::row! {
            "status" => "empty",
...
mod tests {
    ...
    use crate::osp_cli::app::PluginConfigEntry;
    ...
    fn plugin_rows_render_real_metadata_and_scopes_unit() {
        ...
        let commands = command_catalog_rows(&[CommandCatalogEntry {
            ...
            completion: crate::osp_completion::CommandSpec::new("shared"),
        ...
        let config = plugin_config_rows(
            ...
            &[
                PluginConfigEntry {
                    ...
                    scope: crate::osp_cli::app::PluginConfigScope::Shared,
                },
                PluginConfigEntry {
                    env_key: "OSP_PLUGIN_FLAG".to_string(),
                    value: "2".to_string(),
                    config_key: "extensions.plugins.demo.flag".to_string(),
                    scope: crate::osp_cli::app::PluginConfigScope::Plugin,
                },
            ],
        );
