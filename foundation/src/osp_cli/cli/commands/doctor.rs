...
use crate::osp_cli::cli::{DoctorArgs, DoctorCommands, PluginsArgs, PluginsCommands};
use crate::osp_cli::rows::output::rows_to_output_result;
use crate::osp_cli::state::{AuthState, LastFailure, UiState};
use crate::osp_cli::theme_loader::ThemeCatalog;
use crate::osp_core::output::OutputFormat;
use crate::osp_core::row::Row;
use crate::osp_ui::document::{Block, Document, PanelBlock, PanelRules};
use crate::osp_ui::format::build_document_from_output;
...
mod tests {
    ...
    use crate::osp_cli::app::ReplCommandOutput;
    use crate::osp_cli::cli::commands::{config as config_cmd, plugins as plugins_cmd};
    use crate::osp_cli::cli::{DoctorArgs, DoctorCommands};
    use crate::osp_cli::plugin_manager::PluginManager;
    use crate::osp_cli::state::{AuthState, LastFailure, RuntimeContext, TerminalKind, UiState};
    use crate::osp_cli::theme_loader::{ThemeCatalog, ThemeLoadIssue};
    use crate::osp_config::{ConfigLayer, ConfigResolver, ResolveOptions, RuntimeLoadOptions};
    use crate::osp_core::output::OutputFormat;
    use crate::osp_ui::RenderSettings;
    use crate::osp_ui::document::{Block, LinePart};
    ...
    fn theme_doctor_rows_report_issues_and_empty_state_unit() {
        ...
        assert_eq!(
            empty,
            vec![crate::osp_cli::row! { "status" => "ok", "issue_count" => 0 }]
        );
