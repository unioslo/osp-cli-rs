use crate::osp_cli::app::{CliCommandResult, resolve_known_theme_name};
use crate::osp_cli::cli::{ThemeArgs, ThemeCommands, ThemeShowArgs, ThemeUseArgs};
use crate::osp_cli::rows::output::rows_to_output_result;
use crate::osp_cli::state::UiState;
use crate::osp_cli::theme_loader::{ThemeCatalog, ThemeSource};
use miette::Result;
use miette::miette;
use crate::osp_config::ConfigLayer;
...
mod tests {
    ...
    use crate::osp_cli::app::CliCommandResult;
    use crate::osp_cli::app::ReplCommandOutput;
    use crate::osp_cli::cli::{ThemeArgs, ThemeCommands, ThemeShowArgs};
    use crate::osp_cli::state::UiState;
    use crate::osp_cli::theme_loader::{ThemeCatalog, ThemeEntry, ThemeSource};
    use crate::osp_config::ConfigLayer;
    use crate::osp_core::output::OutputFormat;
    use crate::osp_core::row::Row;
    use crate::osp_ui::RenderSettings;
    use crate::osp_ui::messages::MessageLevel;
    use crate::osp_ui::theme::find_builtin_theme;
