...
use crate::osp_completion::CommandSpec;
use crate::osp_config::{ConfigValue, DEFAULT_REPL_HISTORY_MAX_ENTRIES, ResolvedConfig, RuntimeDefaults};
use crate::osp_core::row::Row;
use crate::osp_repl::{HistoryConfig, HistoryEntry, SharedHistory};
use crate::osp_ui::theme::DEFAULT_THEME_NAME;
use std::path::PathBuf;

use crate::osp_cli::cli::{HistoryArgs, HistoryCommands, HistoryPruneArgs};
use crate::osp_cli::state::{AppRuntime, AppSession};

use crate::osp_cli::app::{CMD_HISTORY, CMD_LIST, DEFAULT_REPL_PROMPT, ReplCommandOutput, config_usize};
...
mod tests {
    ...
    use crate::osp_cli::cli::{HistoryArgs, HistoryCommands, HistoryPruneArgs};
    use crate::osp_cli::state::AppSession;
    use crate::osp_config::{ConfigLayer, ConfigResolver, ResolveOptions};
    use crate::osp_repl::{HistoryConfig, SharedHistory};
    ...
    fn config_with_entries(entries: &[(&str, &str)]) -> crate::osp_config::ResolvedConfig {
        let mut defaults = ConfigLayer::default();
    ...
    fn shared_history(enabled: bool) -> SharedHistory {
        ...
        SharedHistory::new(
            HistoryConfig {
                ...
                profile: None,
                terminal: None,
                shell_context: crate::osp_repl::HistoryShellContext::default(),
            }
            .normalized(),
        )
