...
use crate::osp_completion::CommandLineParser;
use crate::osp_config::ResolvedConfig;
use crate::osp_dsl::parse::lexer::split_pipeline;
use crate::osp_repl::LineProjection;
use std::collections::BTreeSet;

use crate::osp_cli::app::{CMD_HELP, REPL_SHELLABLE_COMMANDS};
use crate::osp_cli::invocation::{hidden_invocation_completion_flags, scan_command_tokens_with_trace};
use crate::osp_cli::pipeline::{ParsedCommandLine, parse_command_text_with_aliases};
use crate::osp_cli::state::ReplScopeStack;
    ...
    pub(crate) fn parse(line: &str, config: &ResolvedConfig) -> Result<Self> {
        let parsed = parse_command_text_with_aliases(line, config).wrap_err_with(|| {
            format!(
                ...
                crate::osp_cli::pipeline::truncate_display(line, 60)
            )
        })?;
...
mod tests {
    ...
    fn make_config() -> crate::osp_config::ResolvedConfig {
