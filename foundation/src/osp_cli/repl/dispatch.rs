...
use miette::Result;
use crate::osp_repl::{ReplLineResult, SharedHistory};
...
mod tests {
    ...
    use crate::osp_repl::{HistoryConfig, ReplLineResult, ReplReloadKind, SharedHistory};
...
For more information, try '--help'.\n";
    ...
    fn make_state_with_plugins(plugins: crate::osp_cli::plugin_manager::PluginManager) -> AppState {
    ...
    fn root_help_rendering_and_shell_prefix_helpers_cover_root_paths_unit() {
        let mut state =
            make_state_with_plugins(crate::osp_cli::plugin_manager::PluginManager::new(Vec::new()));
...
"#,
        ...
        let mut state = make_state_with_plugins(crate::osp_cli::plugin_manager::PluginManager::new(vec![
            plugins_dir.clone(),
        ]));
        let invocation = super::base_repl_invocation(&state.runtime);
