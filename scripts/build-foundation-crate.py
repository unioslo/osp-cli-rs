...
def render_foundation_lib(crates: list[CrateInfo]) -> str:
    hidden_module_lines = []
    for crate in crates:
        if crate.module_name == "osp_ui":
            hidden_module_lines.append("mod osp_ui;")
        else:
            hidden_module_lines.append(f"#[doc(hidden)]\npub mod {crate.module_name};")
    hidden_modules = "\n".join(hidden_module_lines)
    ...
    modules = {
        ...
        "ui/mod.rs": textwrap.dedent(
            ...
            pub use render::{
                ...
                PanelRules, RenderBackend, RenderRuntime, RenderSettings, ResolvedRenderSettings,
                Spinner, StyleOverrides, TableAlign, TableBlock, TableBorderStyle,
                TableOverflow, TableStyle, ValueBlock, copy_output_to_clipboard,
                copy_rows_to_clipboard, line_from_inline, parts_from_inline, render_document,
                render_document_for_copy, render_inline, render_output,
                render_output_for_copy, render_rows, render_rows_for_copy,
            };
            """
        ),
        "ui/chrome.rs": "pub use crate::osp_ui::chrome::*;\n",
        "ui/clipboard.rs": "pub use crate::osp_ui::clipboard::*;\n",
        "ui/document.rs": "pub use crate::osp_ui::document::*;\n",
        "ui/format.rs": textwrap.dedent(
            """\
        ...
        "ui/interactive.rs": "pub use crate::osp_ui::interactive::*;\n",
        "ui/messages.rs": "pub use crate::osp_ui::messages::*;\n",
        "ui/render.rs": textwrap.dedent(
            """\
        ...
        "ui/style.rs": "pub use crate::osp_ui::style::*;\n",
        "ui/theme.rs": "pub use crate::osp_ui::theme::*;\n",
        ...
        "repl/history.rs": textwrap.dedent(
            """\
            pub use crate::osp_repl::{
        ...
        "repl/prompt.rs": textwrap.dedent(
            """\
            pub use crate::osp_repl::{
                LineProjection, LineProjector, PromptRightRenderer, ReplAppearance, ReplPrompt,
            };
